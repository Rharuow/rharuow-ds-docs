    ...
    return (
      <div className={cn("relative", containerClassName)} ref={componentRef}>
        <div
          ...
          aria-expanded={open}
          className={cn(
            "peer flex items-center min-h-12 w-full border border-[var(--primary)] rounded-md bg-[var(--input-bg)] text-[var(--input-text)] px-3 py-2 text-sm transition focus:outline-none focus:border-[var(--primary)] disabled:cursor-not-allowed disabled:opacity-50 appearance-none cursor-pointer relative",
            className
          )}
