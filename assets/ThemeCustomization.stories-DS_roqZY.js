import{j as e}from"./utils-DLq8OvKD.js";import{b as v,F as y}from"./index.esm-C8SzPwbq.js";import{B as t}from"./Button-vGQ9ZFtK.js";import{I as g}from"./Input-CoYaNLA3.js";import{R as l}from"./RadioGroup-LXAc-MUi.js";import{S as f}from"./Select-244hPVCi.js";import"./iframe-BH0FnrdN.js";const j=({children:r})=>{const o=v({defaultValues:{name:"",category:"",priority:"",status:""}});return e.jsx(y,{...o,children:e.jsxs("div",{className:"max-w-md mx-auto p-6 space-y-4",children:[r,e.jsxs("div",{className:"mt-6 p-4 bg-gray-50 rounded-lg",children:[e.jsx("h4",{className:"font-semibold text-gray-700 mb-2",children:"Form Values:"}),e.jsx("pre",{className:"text-xs text-gray-600 overflow-auto",children:JSON.stringify(o.watch(),null,2)})]})]})})},z={title:"🎨 Theme Customization",decorators:[r=>e.jsx(j,{children:e.jsx(r,{})})],parameters:{layout:"padded",docs:{description:{component:`
