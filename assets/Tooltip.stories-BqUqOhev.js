import{r as i,R as e}from"./iframe-BP7VOMC9.js";import{r as de}from"./index--F0CPhYh.js";import{c as me}from"./utils-CuF-iVWQ.js";import{B as a}from"./Button-Cd6qRh8o.js";import{C as f}from"./Card-3dZ-4Tt-.js";var pe=de();const t=({content:d,children:C,position:s="top",className:Y="",disabled:y=!1})=>{const[m,p]=i.useState(!1),[_,Z]=i.useState(s),[ee,te]=i.useState({}),w=i.useRef(null),B=i.useRef(null);i.useEffect(()=>{if(!m||!B.current)return;const o=B.current.getBoundingClientRect();let c=s,r=0,l=0;switch(s){case"top":r=o.top-8,l=o.left+o.width/2;break;case"bottom":r=o.bottom+8,l=o.left+o.width/2;break;case"left":r=o.top+o.height/2,l=o.left-8;break;case"right":r=o.top+o.height/2,l=o.right+8;break}if(w.current){const u=w.current.getBoundingClientRect(),ie=window.innerWidth,ce=window.innerHeight;s==="top"&&o.top<u.height+16?(c="bottom",r=o.bottom+8):s==="bottom"&&o.bottom+u.height+16>ce?(c="top",r=o.top-8):s==="left"&&o.left<u.width+16?(c="right",l=o.right+8):s==="right"&&o.right+u.width+16>ie&&(c="left",l=o.left-8)}Z(c),te({position:"fixed",top:`${r}px`,left:`${l}px`,zIndex:9999})},[m,s]);const oe=()=>{y||p(!0)},ae=()=>{p(!1)},ne=()=>{y||p(!0)},se=()=>{p(!1)},re=()=>{const n="pointer-events-none";switch(_){case"top":return`${n} transform -translate-x-1/2 -translate-y-full`;case"bottom":return`${n} transform -translate-x-1/2`;case"left":return`${n} transform -translate-x-full -translate-y-1/2`;case"right":return`${n} transform -translate-y-1/2`;default:return`${n} transform -translate-x-1/2 -translate-y-full`}},le=()=>{const n="absolute w-2 h-2 bg-[var(--tooltip-bg,#374151)] transform rotate-45";switch(_){case"top":return`${n} top-full left-1/2 -translate-x-1/2 -translate-y-1/2`;case"bottom":return`${n} bottom-full left-1/2 -translate-x-1/2 translate-y-1/2`;case"left":return`${n} left-full top-1/2 -translate-y-1/2 -translate-x-1/2`;case"right":return`${n} right-full top-1/2 -translate-y-1/2 translate-x-1/2`;default:return`${n} top-full left-1/2 -translate-x-1/2 -translate-y-1/2`}};return y||!d?e.createElement(e.Fragment,null,C):e.createElement(e.Fragment,null,e.createElement("div",{className:"relative inline-block",ref:B,onMouseEnter:oe,onMouseLeave:ae,onFocus:ne,onBlur:se},C),m&&typeof document<"u"&&pe.createPortal(e.createElement("div",{ref:w,style:ee,className:me(re(),"px-2 py-1 text-sm rounded whitespace-nowrap","bg-[var(--tooltip-bg,#374151)] text-[var(--tooltip-text,#fff)]","shadow-[var(--tooltip-shadow,0_10px_15px_-3px_rgb(0_0_0_/_0.1),_0_4px_6px_-4px_rgb(0_0_0_/_0.1))]","transition-opacity duration-200 ease-in-out",Y),role:"tooltip","aria-hidden":!m},d,e.createElement("div",{className:le()})),document.body))};t.__docgenInfo={description:"",methods:[],displayName:"Tooltip",props:{content:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},position:{required:!1,tsType:{name:"union",raw:'"top" | "bottom" | "left" | "right"',elements:[{name:"literal",value:'"top"'},{name:"literal",value:'"bottom"'},{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}]},description:"",defaultValue:{value:'"top"',computed:!1}},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const Ee={title:"Components/Tooltip",component:t,tags:["autodocs"],argTypes:{position:{control:{type:"select"},options:["top","bottom","left","right"]},disabled:{control:{type:"boolean"}}}},v={args:{content:"Este é um tooltip padrão",position:"top"},render:d=>e.createElement("div",{className:"p-8 flex justify-center"},e.createElement(t,{...d},e.createElement(a,null,"Passe o mouse aqui")))},g={render:()=>e.createElement("div",{className:"p-16 grid grid-cols-2 gap-8 place-items-center"},e.createElement(t,{content:"Tooltip no topo",position:"top"},e.createElement(a,null,"Top")),e.createElement(t,{content:"Tooltip na direita",position:"right"},e.createElement(a,null,"Right")),e.createElement(t,{content:"Tooltip embaixo",position:"bottom"},e.createElement(a,null,"Bottom")),e.createElement(t,{content:"Tooltip na esquerda",position:"left"},e.createElement(a,null,"Left")))},x={render:()=>e.createElement("div",{className:"p-8 flex justify-center"},e.createElement(t,{content:"Informação adicional sobre este texto"},e.createElement("span",{className:"underline cursor-help"},"Texto com tooltip")))},E={render:()=>e.createElement("div",{className:"p-8 flex justify-center"},e.createElement(t,{content:"Este é um tooltip com conteúdo mais longo para demonstrar como ele se comporta"},e.createElement(a,null,"Tooltip com conteúdo longo")))},b={render:()=>e.createElement("div",{className:"p-8 flex justify-center"},e.createElement(t,{content:"Este tooltip está desabilitado",disabled:!0},e.createElement(a,null,"Tooltip desabilitado")))},T={render:()=>e.createElement("div",{className:"p-8 flex justify-center"},e.createElement(t,{content:"Tooltip customizado",className:"bg-red-500 text-white"},e.createElement(a,{variant:"outline"},"Tooltip customizado")))},h={render:()=>e.createElement("div",{className:"p-8 flex justify-center"},e.createElement("div",{className:"w-80"},e.createElement("div",{className:"bg-gray-100 p-4 rounded-lg",style:{overflow:"hidden"}},e.createElement("h3",{className:"text-lg font-semibold mb-4"},"Container com overflow: hidden"),e.createElement("div",{className:"space-y-4"},e.createElement(t,{content:"Tooltip que funciona mesmo com overflow hidden",position:"top"},e.createElement(a,{className:"w-full"},"Tooltip no topo")),e.createElement(t,{content:"Tooltip posicionado à direita",position:"right"},e.createElement(a,{className:"w-full"},"Tooltip à direita")),e.createElement(t,{content:"Tooltip posicionado embaixo",position:"bottom"},e.createElement(a,{className:"w-full"},"Tooltip embaixo")),e.createElement(t,{content:"Tooltip posicionado à esquerda",position:"left"},e.createElement(a,{className:"w-full"},"Tooltip à esquerda"))),e.createElement("div",{className:"mt-4 p-3 bg-yellow-100 rounded text-sm"},e.createElement("p",null,"⚠️ Este container tem ",e.createElement("code",null,"overflow: hidden")," aplicado, mas os tooltips ainda funcionam corretamente usando Portal!")))))},N={render:()=>e.createElement("div",{className:"p-8 flex justify-center"},e.createElement("div",{className:"w-96"},e.createElement(f,{variant:"elevated"},e.createElement(f.Header,null,e.createElement("div",{className:"flex justify-between items-center"},e.createElement("h3",{className:"text-lg font-semibold"},"Dashboard Analytics"),e.createElement(t,{content:"Informações sobre este dashboard",position:"left"},e.createElement("button",{className:"text-gray-500 hover:text-gray-700"},"ℹ️")))),e.createElement(f.Body,null,e.createElement("div",{className:"grid grid-cols-2 gap-4 mb-4"},e.createElement("div",{className:"text-center"},e.createElement(t,{content:"Total de vendas do mês atual",position:"top"},e.createElement("div",{className:"bg-blue-50 p-3 rounded-lg cursor-help"},e.createElement("div",{className:"text-2xl font-bold text-blue-600"},"R$ 45.2k"),e.createElement("div",{className:"text-sm text-gray-600"},"Vendas")))),e.createElement("div",{className:"text-center"},e.createElement(t,{content:"Número de novos clientes este mês",position:"top"},e.createElement("div",{className:"bg-green-50 p-3 rounded-lg cursor-help"},e.createElement("div",{className:"text-2xl font-bold text-green-600"},"127"),e.createElement("div",{className:"text-sm text-gray-600"},"Clientes"))))),e.createElement("p",{className:"text-sm text-gray-600 mb-4"},"Este Card tem ",e.createElement("code",null,"overflow: hidden")," aplicado, mas todos os tooltips funcionam perfeitamente."),e.createElement("div",{className:"flex space-x-2"},e.createElement(t,{content:"Ver relatório detalhado",position:"bottom"},e.createElement(a,{variant:"outline",className:"flex-1"},"Relatório")),e.createElement(t,{content:"Exportar dados para Excel",position:"bottom"},e.createElement(a,{className:"flex-1"},"Exportar")))),e.createElement(f.Footer,null,e.createElement("div",{className:"flex justify-between items-center"},e.createElement(t,{content:"Última atualização dos dados",position:"top"},e.createElement("span",{className:"text-xs text-gray-500 cursor-help"},"Atualizado: 30/09/2025")),e.createElement(t,{content:"Configurar alertas automáticos",position:"top"},e.createElement("button",{className:"text-blue-600 text-sm hover:underline"},"Configurar Alertas"))))))),parameters:{docs:{description:{story:"Exemplo realista de tooltips funcionando dentro de um Card com overflow: hidden. Todos os tooltips são renderizados usando Portal, garantindo que apareçam corretamente independente do container pai."}}}};var R,j,q;v.parameters={...v.parameters,docs:{...(R=v.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
...
}`,...(q=(j=v.parameters)==null?void 0:j.docs)==null?void 0:q.source}}};var S,$,P;g.parameters={...g.parameters,docs:{...(S=g.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...(P=($=g.parameters)==null?void 0:$.docs)==null?void 0:P.source}}};var z,I,V;x.parameters={...x.parameters,docs:{...(z=x.parameters)==null?void 0:z.docs,source:{originalSource:`{
...
}`,...(V=(I=x.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};var A,D,k;E.parameters={...E.parameters,docs:{...(A=E.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => <div className="p-8 flex justify-center">
...
}`,...(k=(D=E.parameters)==null?void 0:D.docs)==null?void 0:k.source}}};var F,L,H;b.parameters={...b.parameters,docs:{...(F=b.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => <div className="p-8 flex justify-center">
...
}`,...(X=(U=N.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};const be=["Default","Positions","WithText","LongContent","Disabled","CustomStyle","InsideCard","InsideCardComponent"];export{T as CustomStyle,v as Default,b as Disabled,h as InsideCard,N as InsideCardComponent,E as LongContent,g as Positions,x as WithText,be as __namedExportsOrder,Ee as default};
